namespace StringsAndArrays
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            string name = gatherInput<string>("");
            ...
            Console.WriteLine($"Your name in all caps is: {name.ToUpper()}");
            ...
            if (containsWorld)
            {
                int indexPos = helloWorld.IndexOf("World");
                Console.WriteLine($"World is at index: {indexPos}");
            }
            ...
            {
                string nom = gatherInput<string>("Please enter a name: ");
                names[i] = nom;
            }

            // 2.3 Output the array of given names.

            Console.WriteLine($"Output of given names: {String.Join(", ", names)}");

            // 2.4 Reverse the order of the items in the names array and outpu the result
            Array.Reverse(names);

            Console.WriteLine($"Reversed output of given names: {String.Join(", ", names)}");
            ...
            if (position >= 0)
            {
                Console.WriteLine($"Search Name is: {searchName}. Position is: {position}");
            }
            else
            {
            ...
            Console.WriteLine($"Output of words array: {String.Join(" ", words)}");
        }
